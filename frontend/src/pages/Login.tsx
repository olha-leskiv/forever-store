...
const Login = () => {
  const [ currentState, setCurrentState ] = useState<'Sign up' | 'Login'>('Login');
  ...
  return (
    <form onSubmit={SubmitHandler} className="flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800">
     ...
     {currentState === "Sign up" && <input value={name} onChange={(e) => setName(e.target.value)} type="text" className="w-full px-3 py-2 border border-gray-800" placeholder="Name" required />} 
