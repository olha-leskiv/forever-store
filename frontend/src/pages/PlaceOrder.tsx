    ...
    try {
      ...
      switch(method) {
        case 'cod':
          ...
          case 'stripe':
             responseStripe = await axios.post(backendUrl + '/api/order/stripe', orderData, {headers: {token}})
    ...
    <form onSubmit={onSubmitHandler} className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t">
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        <div className="my-3 text-xl sm:text-2xl">
          <Title text1="Delivery" text2="Informztion" />
        </div>
      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="w-full mt-8 text-end">
            <button type="submit" className="px-16 py-3 text-sm text-white uppercase bg-black">Place Order</button>
          </div>
        </div>
      </div>
